...
const STRING_FREQUENCIES: Record<string, number[]> = {
  E: [329.63],
  Am: [0, 220.0, 329.63, 440.0, 523.25, 659.25],
  Em: [329.63, 246.94, 329.63, 392.0, 493.88, 659.25],
  Em7: [329.63, 246.94, 293.66, 392.0, 493.88, 659.25],
  C: [0, 261.63, 329.63, 392.0, 523.25, 659.25],
  Cadd9: [0, 261.63, 329.63, 392.0, 587.33, 659.25],
  G: [196.0, 246.94, 392.0, 392.0, 493.88, 784.0],
  Gsus4: [196.0, 261.63, 293.66, 392.0, 523.25, 784.0],
  D: [0, 0, 293.66, 369.99, 440.0, 587.33],
  Dm: [0, 0, 293.66, 349.23, 440.0, 587.33],
  Dsus2: [0, 0, 293.66, 329.63, 440.0, 587.33],
  Dsus4: [0, 0, 293.66, 392.0, 440.0, 587.33],
  A: [0, 220.0, 329.63, 440.0, 554.37, 659.25],
  Asus4: [0, 220.0, 329.63, 440.0, 587.33, 659.25],
  F: [174.61, 220.0, 261.63, 349.23, 440.0, 523.25],
  A7: [0, 220.0, 329.63, 392.0, 554.37, 659.25],
  E7: [329.63, 246.94, 329.63, 349.23, 493.88, 659.25],
  D7: [0, 0, 293.66, 349.23, 440.0, 523.25]
}
